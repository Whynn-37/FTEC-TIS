        ...
        <div class="row">
            <div class="col-lg-12 mt-5">
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <h4 class="header-title"><i class="ti-clipboard"></i> APPROVED INSPECTION DATA</h4><br>
                        <div class="row">
                            <div class="col-md-12">
...
<?php echo $__env->make('Template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TIS\resources\views/Approver/approval.blade.php ENDPATH**/ ?>