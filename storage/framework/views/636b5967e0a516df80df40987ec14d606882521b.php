                            ...
                            <tr>
                                <td align="center" class="main-header"
                                    ...
                                    <div style="line-height: 50px;">
                                        APPROVED <span style="text-transform: uppercase;"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            style="text-align:center;font-family: Open Sans, Helvetica, sans-serif;padding:20px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size:16px;background-color:#dfdfe2;color:#000000;"> <?php echo e($data['inspect_by']); ?> </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size:16px;background-color:#dfdfe2;color:#000000;"> Japanese </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size:16px;background-color:#dfdfe2;color:#000000;"> <?php echo e($data['evaluated_by']); ?> </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size:16px;background-color:#dfdfe2;color:#000000;"> Japanese </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size:16px;background-color:#dfdfe2;color:#000000;"> <?php echo e($data['approved_by']); ?> </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size:16px;background-color:#dfdfe2;color:#000000;"> Japanese </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size:16px;background-color:#dfdfe2;color:#000000;"> APPROVED </td>
                                                    </tr>
                                                </tbody>
                                        </table>
                                        <tr>
...
<?php /**PATH C:\xampp\htdocs\TIS\resources\views/Mail/approved.blade.php ENDPATH**/ ?>