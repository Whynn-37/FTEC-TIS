        ...
        <div class="row">
            <div class="col-lg-12 mt-5">
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <h4 class="header-title"><i class="ti-clipboard"></i> FINISHED INSPECTION DATA</h4>
                        <form id="form_trial_checksheet" method="post" enctype="multipart/form-data">
                            ...
                            <div id="accordion_attachment" class="according accordion-s2 gradiant-bg mb-3" hidden>
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-body"><br>
                                            <div class="row">
                                                <div class="vertical-rectangle">
                                                    <img src="<?php echo e(asset('template/assets/images/icon/file.png')); ?>" alt="Avatar" class="file-image" style="width:100%">
                            ...
                            <div id="accordion_igm" class="according accordion-s2 gradiant-bg mb-5" hidden>
                                <div class="card">
                                    <div class="card-header">
                                                            ...
                                                            <table class="table text-center table-sm table-bordered" id="tbl_igm">
                                                                ...
                                                                <tbody id="tbody_tbl_igm">
                                                                    <tr id="tr_item_no_1">
                                                                        ...
                                                                        <td colspan="3" id="td_item_no_1_hinsei">  
...
<?php echo $__env->make('Template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TIS\resources\views/Evaluator/finished_evaluation.blade.php ENDPATH**/ ?>