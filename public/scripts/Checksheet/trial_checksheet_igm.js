    ...
    this_igm.GetChecksheetDatas = (bg_header = "th_new_igm_sub_column",data) => {
        ...
        for (let a_index = 0; a_index < data.data.datas.length; a_index++) 
        {
            ...
            for (let b_index = 0; b_index < array_hidden_checksheet_data_id.length; b_index++) 
            {
                ...
                IGM.AddIgmSubNo(array_load_igm_type[a_index], array_load_igm_item_number[a_index], existing_sub_no_count, 0, bg_header,array_hidden_checksheet_data_id[b_index],'select_item_type',array_data[b_index],array_judgement[b_index],array_coordinates[b_index]);
    ...
    this_igm.AddIgmItemNoInputs = (type, tr_new_item_header, previous_item_no,remove_status) => {
        ...
        let tr_new_item = `${tr_new_item_header}
            <tr id="tr_item_no_${item_no_holder}">
				...
				<td>
					<input id="txt_item_no_${item_no_holder}_lower_limit" type="number" class="form-control input_text_center" placeholder="Enter lower limit" disabled onkeyup="IGM.ValidateItemNoUpperAndLowerLimit(${item_no_holder});" onkeypress="return event.charCode >= 43 && event.charCode <= 57">
				</td>
    ...
    this_igm.AddIgmSubNoInputs = (type, next_number, tr_sub_no_column, item_no_count, existing_sub_no_count_per_item, added_item_no_between_count, checksheet_data_id,array_data,judgement,coordinates) => {
        ...
        if (type === 'Min and Max' || type === 'Min and Max and Form Tolerance') 
        {
            ...
            <tr id="tr_item_no_${item_no_count}_sub_no_min_${new_sub_no}" >
				...
				<td style="vertical-align: middle;" rowspan="2">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_coordinates" type="text" class="form-control input_text_center" placeholder="Enter Coordinates" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},'','')" value="${new_coordinates}">
				</td>
				<td class="td_sub_no_input">
					<input  id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_min_1" type="text" class="form-control input_text_center" placeholder="Enter Min" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},1,'min')" title='min' value="${IGM.ChecksheetDataInputData(array_data,0)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},'min_1');">
				</td>
				<td class="td_sub_no_input">
					<input  id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_min_2" type="text" class="form-control input_text_center" placeholder="Enter Min" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},2,'min')" title='min' value="${IGM.ChecksheetDataInputData(array_data,2)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},'min_2');">
				</td>
				<td class="td_sub_no_input">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_min_3" type="text" class="form-control input_text_center" placeholder="Enter Min" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},3,'min')" title='min' value="${IGM.ChecksheetDataInputData(array_data,4)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},'min_3');">
				</td>
				<td class="td_sub_no_input">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_min_4" type="text" class="form-control input_text_center" placeholder="Enter Min" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},4,'min')" title='min' value="${IGM.ChecksheetDataInputData(array_data,6)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},'min_4');">
				</td>
				<td class="td_sub_no_input">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_min_5" type="text" class="form-control input_text_center" placeholder="Enter Min" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},5,'min')" title='min' value="${IGM.ChecksheetDataInputData(array_data,8)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},'min_5');">
				</td>
			...
			<tr id="tr_item_no_${item_no_count}_sub_no_max_${new_sub_no}">
				<td class="td_sub_no_input">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_max_1" type="text" class="form-control input_text_center" placeholder="Enter Max" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},1,'max')" title='max' value="${IGM.ChecksheetDataInputData(array_data,1)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},'max_1');">
				</td>
				<td class="td_sub_no_input">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_max_2" type="text" class="form-control input_text_center" placeholder="Enter Max" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},2,'max')" title='max' value="${IGM.ChecksheetDataInputData(array_data,3)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},'max_2');">
				</td>
				<td class="td_sub_no_input">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_max_3" type="text" class="form-control input_text_center" placeholder="Enter Max" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},3,'max')" title='max' value="${IGM.ChecksheetDataInputData(array_data,5)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},'max_3');">
				</td>
				<td class="td_sub_no_input">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_max_4" type="text" class="form-control input_text_center" placeholder="Enter Max" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},4,'max')" title='max' value="${IGM.ChecksheetDataInputData(array_data,7)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},,'max_4');">
				</td>
				<td class="td_sub_no_input">
					<input id="txt_item_no_${item_no_count}_sub_no_${new_sub_no}_max_5" type="text" class="form-control input_text_center" placeholder="Enter Max" autocomplete="off" onchange="IGM.SubItemGetMinMax(${item_no_count},${new_sub_no},5,'max')" title='max' value="${IGM.ChecksheetDataInputData(array_data,9)}" onkeypress="return event.charCode >= 43 && event.charCode <= 57" onclick="IGM.CheckIfDashValue('${IGM.ChecksheetDataInputData(array_data,8)}',${item_no_count},${new_sub_no},','max_5');">
				</td>
			</tr>`;
        } 
        else 
        ...
        else
        {
            ...
            if (last_max_value !== '')
            {
                for (let c_count = 1; c_count <= 5; c_count++) 
                {
                    ...
                    //DAGDAGAN ANG CONDITION NG "/+""/-""-/"""+/, TSAKA PAG KA MADAMING +,-,-/,',',
...
// NATAPOS SA PAGLALAGAY NG CONDITION KAPAG '-' ANG VALUE. TSAKA PAG SESET TO DASH NG DEFAULT NA VALUE PAGKA WALA PANG LAMAN. TSAKA ONCLICK NA KAPAG NAKA DASH VALUE AY I-CCLEAR YUNG DASH