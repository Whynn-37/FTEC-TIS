    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-block btn-lg btn-font-lg" onclick="EVALUATE.ApproveData();"><i class="ti-check"></i> APPROVE</button>
                <button type="button" class="btn btn-secondary btn-block btn-lg btn-font-lg" data-dismiss="modal"><i class="ti-close"></i> CANCEL</button>
            </div>
        </div>
    </div>
</div>
